...
def inputs(argv):
    def usage(short=True):
        ...
        print(' N.B. the sampling of the filter transmission profile sets the ')
        print('      sampling used for calculating the integrated flux.')
        print('      Very fine sampling will slow down the calculation. ')
        print('      A filter profile with only 2 or 3 points may add numerical')
        print('      noise to the calculation of magnitudes and flux ratios.')
        print(' ')
